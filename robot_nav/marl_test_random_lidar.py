...
def main(args=None):
    ...
    model = TD3WithLiDAR(
        ...
        load_model=True,
        model_name="MARL-LiDAR-test-finetune-reward4_epoch300",
        load_model_name="MARL-LiDAR-train-finetune-reward4_epoch300",
        load_directory=Path("robot_nav/models/MARL/marlTD3/checkpoint/Jan.24_obstacle_finetune"),
        attention="igs",
        use_lidar=True,

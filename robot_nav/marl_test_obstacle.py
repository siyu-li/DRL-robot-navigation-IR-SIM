...
def main(args=None):
    ...
    model = TD3Obstacle(
        ...
        device=device,
        load_model=True,
        model_name="TD3-MARL-obstacle_v2_epoch900",
        load_model_name="TD3-MARL-obstacle_v2_epoch900",
        load_directory=Path("robot_nav/models/MARL/marlTD3/checkpoint/obstacle_v2"),
    )
